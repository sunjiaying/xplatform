...
活动.基折价最低商品免单 = function (本单, 可参与本活动的商品清单, 不可以参加本活动的商品清单) {
  var 基折价最低商品款号 = '';
  var 基折价最低商品基折价 = 99999999999;
  打印('基折价最低商品基折价', 基折价最低商品基折价);
...
活动.活动折扣 = function (本单, 可参与本活动的商品清单, 不可以参加本活动的商品清单, 返现额前折, 返现额后折) {
  本单.商品清单.forEach(item => {
    if (
      通用.匹配(item.款号, 可参与本活动的商品清单) && 
      !通用.匹配(item.款号, 不可以参加本活动的商品清单) &&
...
活动.分摊抵用额 = function (本单, 可参与本活动的商品清单, 不可以参加本活动的商品清单, 可抵用额) {
  // 思路：
