...
优惠券.分摊优惠券额 = function (本单, 可参与本活动的商品清单, 不可以参加本活动的商品清单) {
  if (!本单.优惠券 || 本单.优惠券.length<1)
    return;
  
  本单.优惠券.forEach(coupon => {
    if (coupon.使用) {
      优惠券.分摊一张优惠券额(本单, 可参与本活动的商品清单, 不可以参加本活动的商品清单, coupon);
    }
  });
};

优惠券.分摊一张优惠券额 = function (本单, 可参与本活动的商品清单, 不可以参加本活动的商品清单, 优惠券) {
  // 思路：
